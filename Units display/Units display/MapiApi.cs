...
namespace Win32Mapi
{
    ...
    public class Mapi
    {
        ...
        private void Dealloc()
        {
            ...
            {
                long runptr = (long)lastMsg.recips;
            ...
            if (lastMsg.files != IntPtr.Zero)
            {
                ...
                long runptr = (long)lastMsg.files;
        ...
        public bool Next(ref MailEnvelop env)
        {
            ...
            env.id = findseed;
            env.date = DateTime.ParseExact(lastMsg.dateReceived, "yyyy/MM/dd", DateTimeFormatInfo.InvariantInfo);
